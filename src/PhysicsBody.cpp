...
void PhysicsBody::GenerateWind() {
    do {
        float angle = GetRandomValue(0,359) * DEG2RAD; //random compass direction, GetRandomValue is raylib's built in random number generator, cosf, sinf from cmath only work in radians so we convert.
