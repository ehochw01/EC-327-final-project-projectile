...
class Target : public Entity {
    public:
        ...
        void ChangeColor();   // changes the color of the target to a new color from the palette, for visual interest
    ...
    private:
        ...
        Color color{kPalette[ColorIndex]}; // target color intialized to red
};
